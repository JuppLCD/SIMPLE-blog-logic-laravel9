<x-layouts.admin>
    ...
    <form action="{{route('admin.tags.update', $tag)}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input value="{{old('name', $tag->name)}}" type="text" class="form-control" id="name" name="name"
                aria-describedby="nameTag">
        </div>

        <div class="mb-3">
            <label for="slug" class="form-label">Slug Tag:</label>
            <input value="{{old('slug', $tag->slug)}}" type="text" class="form-control" id="slug" name="slug"
